...
import { PesquisaPreviewPage } from './pages/PesquisaPreviewPage/PesquisaPreviewPage'
...
import { AnaliseEnviosPage } from './pages/AnaliseEnviosPage/AnaliseEnviosPage'
    ...
    <Routes>
      ...
      <Route element={<RotaProtegida papeis={['admin', 'gestor_rh']} />}>
        <Route element={<PainelAdminLayout />}>
          ...
          <Route path="/pesquisas/:id/preview" element={<PesquisaPreviewPage />} />
          ...
          <Route path="/analise/envios" element={<AnaliseEnviosPage />} />
        </Route>
      </Route>
